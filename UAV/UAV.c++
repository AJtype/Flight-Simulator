...
UAV::UAV(const SimParams &params, const int id) 
    ...
    velocity(params.v0), minRadius(params.r0), azimuth(params.az), 
    target_x(params.x0), target_y(params.y0), target_z(params.z0), isCircling(false) {
...
void UAV::print() const {
    ...
    std::cout << "UAV.velocity = " << velocity << std::endl;
